 ...
 */
public class ListCardArtistAdapter extends RecyclerView.Adapter<ListCardArtistAdapter.CardViewHolder> {
    ...
    public ListCardArtistAdapter(ArrayList<Artist> listArtist, Context mContext) {
