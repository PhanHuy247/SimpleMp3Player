 ...
 */
public class AdapterChartSong extends RecyclerView.Adapter<AdapterChartSong.ChartSongViewHolder> {
    ArrayList<Song> listSong;
    Context mContext;
    View itemView;

    OnItemClickListener onItemClickListener;
    public AdapterChartSong(ArrayList<Song> listSong, Context mContext) {
    ...
    public ChartSongViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView
                = layoutInflater.inflate(R.layout.item_chart_song, parent, false);
