 ...
 */
public  class   CategoryPopRockVietNamFragment extends Fragment {
    ...
    public CategoryPopRockVietNamFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_category_pop_rock_viet_nam, container, false);
        setupView(view);
