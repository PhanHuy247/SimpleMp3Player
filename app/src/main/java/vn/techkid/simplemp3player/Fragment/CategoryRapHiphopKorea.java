 ...
 */
public class CategoryRapHiphopKorea extends Fragment {


    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryRapHiphopKorea() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_rap_hiphop_korea, container, false);
        setupView(view);
