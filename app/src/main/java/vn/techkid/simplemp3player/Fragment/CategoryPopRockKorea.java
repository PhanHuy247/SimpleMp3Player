 ...
 */
public class CategoryPopRockKorea extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryPopRockKorea() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_pop_rock_korea, container, false);
        setupView(view);
