 ...
 */
public class CategoryDanceRemixUsUk extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryDanceRemixUsUk() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_dance_remix_us_uk, container, false);
        setupView(view);
