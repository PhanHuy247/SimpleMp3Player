 ...
 */
public class CategoryRapHipHopUsUk extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryRapHipHopUsUk() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_rap_hip_hop_us_uk, container, false);
        setupView(view);
