 ...
 */
public class CategoryRapHipHopVietNamFragment extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryRapHipHopVietNamFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view = inflater.inflate(R.layout.fragment_category_rap_hip_hop_viet_nam, container, false);
        setupView(view);
