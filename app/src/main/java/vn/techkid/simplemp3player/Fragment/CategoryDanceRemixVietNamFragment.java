 ...
 */
public class CategoryDanceRemixVietNamFragment extends Fragment {
    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;

    public CategoryDanceRemixVietNamFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_dance_remix_viet_nam, container, false);
        setupView(view);
