 ...
 */
public class CategoryPopRockUsUk extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryPopRockUsUk() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_pop_rock_us_uk, container, false);
        setupView(view);
