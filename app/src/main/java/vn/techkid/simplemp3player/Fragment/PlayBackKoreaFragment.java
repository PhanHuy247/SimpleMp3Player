 ...
 */
public class PlayBackKoreaFragment extends Fragment {
    ArrayList<PlayBack> listPlayBack;
    RecyclerView recyclerView;
    AdapterPlayBack adapter;

    public PlayBackKoreaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_play_back_korea, container, false);
        setupView(view);
