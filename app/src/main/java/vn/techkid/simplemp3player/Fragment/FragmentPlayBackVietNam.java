 ...
 */
public class FragmentPlayBackVietNam extends Fragment {
    ArrayList<PlayBack> listPlayBack;
    RecyclerView recyclerView;
    AdapterPlayBack adapter;


    public FragmentPlayBackVietNam() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_play_back_viet_nam, container, false);
        setupView(view);
