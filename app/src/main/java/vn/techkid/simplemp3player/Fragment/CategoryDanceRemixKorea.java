 ...
 */
public class CategoryDanceRemixKorea extends Fragment {

    ArrayList<Category> listCategory;
    RecyclerView recyclerView;
    AdapterCategory adapter;
    public CategoryDanceRemixKorea() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_dance_remix_korea, container, false);
        setupView(view);
